<template>
  <div class="w-screen h-screen">
    ...
    <div class="fixed w-screen h-screen ml-60 bg-spoBlack">
      <div class="content ml-12 mr-72 bg-lightess">
        <div class="header bg-spoGreen h-16 flex justify-between items-center">
          ...
          <div class="account flex">
            <button class="bg-black text-white text-xs tracking-widest font-semibold border border-white rounded-full w-36 py-2 mr-4">
              S'ABONNER
            </button>
            <button class="flex justify-around items-center bg-black text-white text-xs tracking-widest font-semibold rounded-full w-32ù py-1">
